...
public class MyCalc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TEXNOLOGIA LOGISMIKOY PROJECT 2 SMART CALCULATOR");
    ...
    private void equalsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_equalsActionPerformed
        ...
        if(binToDecClick>0){
           // total = Integer.parseInt(first,16);
            display.setText("="+String.valueOf(total));
            first=0;    //initiallize to 0
            second=0;   //initiallize to 0
            binToDecClick=0;
        ...
        //percent calculation
        if(percentClick>0){
            PerCentCalc pe=new PerCentCalc();
            total=pe.numberper(first,second);
            display.setText(String.valueOf(total));
            first=0;
            second=0;
            percentClick=0;
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        first=Double.parseDouble(String.valueOf(display.getText()));//percentage
        display.setText("");
        display2.setText(display2.getText()+" give second number to calculate % ");
        percentClick=1;
